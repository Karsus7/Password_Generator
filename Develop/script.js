...
var characters = ["!", "@", "#", "$", "%", "^", "&", "*"]
//"confirmed" variable refers to all used arrays selected in confirms.
...
//Above "while" tells the prompts to appear if none of the options have been selected "yet", triggering the confirms.
    do {
...
// Adds an event listener to recognize the clicking of the generate password button.
